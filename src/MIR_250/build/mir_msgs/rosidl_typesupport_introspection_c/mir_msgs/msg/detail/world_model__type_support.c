...
static rosidl_typesupport_introspection_c__MessageMember mir_msgs__msg__WorldModel__rosidl_typesupport_introspection_c__WorldModel_message_member_array[2] = {
  {
    "header",  // name
