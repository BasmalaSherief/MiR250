...
static rosidl_typesupport_introspection_c__MessageMember mir_msgs__msg__BMSData__rosidl_typesupport_introspection_c__BMSData_message_member_array[47] = {
  {
    "pack_voltage",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs__msg__BMSData, temperature3),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
