...
static rosidl_typesupport_introspection_c__MessageMember mir_msgs__msg__HeightState__rosidl_typesupport_introspection_c__HeightState_message_member_array[3] = {
  {
    "state_string",  // name
    ...
    offsetof(mir_msgs__msg__HeightState, state_string),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs__msg__HeightState, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
