...
#include "geometry_msgs/msg/detail/point__functions.h"  // collision_point
  ...
  void * untyped_ros_message)
{
  ...
  _ResourceState__ros_msg_type * ros_message = static_cast<_ResourceState__ros_msg_type *>(untyped_ros_message);
  // Field name: assigned
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
