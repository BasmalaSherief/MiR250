...
class GripperState(metaclass=Metaclass_GripperState):
    ...
    def __init__(self, **kwargs):
        ...
        self.state_string = kwargs.get('state_string', str())
        self.state = kwargs.get('state', int())
        self.closed = kwargs.get('closed', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.state_string != other.state_string:
            return False
    ...
    def state_string(self, value):
        if __debug__:
            assert \
                ...
                "The 'state_string' field must be of type 'str'"
