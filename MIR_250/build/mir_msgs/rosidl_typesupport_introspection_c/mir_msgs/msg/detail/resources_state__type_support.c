...
static rosidl_typesupport_introspection_c__MessageMember mir_msgs__msg__ResourcesState__rosidl_typesupport_introspection_c__ResourcesState_message_member_array[2] = {
  {
    "header",  // name
