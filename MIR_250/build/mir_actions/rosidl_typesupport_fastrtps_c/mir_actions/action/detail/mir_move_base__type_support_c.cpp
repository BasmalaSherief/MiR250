  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_Goal__ros_msg_type * ros_message = static_cast<_MirMoveBase_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: move_task
  {
    cdr >> ros_message->move_task;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_Result__ros_msg_type * ros_message = static_cast<_MirMoveBase_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: end_state
  {
    cdr >> ros_message->end_state;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_Feedback__ros_msg_type * ros_message = static_cast<_MirMoveBase_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
    cdr >> ros_message->state;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mir_actions, action, MirMoveBase_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_SendGoal_Request__ros_msg_type * ros_message = static_cast<_MirMoveBase_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_SendGoal_Response__ros_msg_type * ros_message = static_cast<_MirMoveBase_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_GetResult_Request__ros_msg_type * ros_message = static_cast<_MirMoveBase_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mir_actions, action, MirMoveBase_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_GetResult_Response__ros_msg_type * ros_message = static_cast<_MirMoveBase_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mir_actions, action, MirMoveBase_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MirMoveBase_FeedbackMessage__ros_msg_type * ros_message = static_cast<_MirMoveBase_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
