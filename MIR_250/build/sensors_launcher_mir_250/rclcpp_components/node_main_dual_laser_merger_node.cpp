...
#define NODE_MAIN_LOGGER_NAME "dual_laser_merger_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsensors_launcher_mir_250.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<merger_node::MergerNode>";
